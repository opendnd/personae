...
class Personae {
  ...
  validateOpts(opts = {}) {
    ...
    if (!defaults.types.ignoreCaseIncludes(opts.type)) opts.type = defaults.type;
    opts.type = opts.type.toUpperCase();

    if ((opts.race === undefined) || (opts.race === '')) opts.race = defaults.races.sample();
    if (!defaults.races.ignoreCaseIncludes(opts.race)) opts.race = defaults.races.sample();
    opts.race = opts.race.capitalizeAll();

    // class
    if ((opts.klass === undefined) || (opts.klass === '')) opts.klass = defaults.classes.sample();
    if (!defaults.classes.ignoreCaseIncludes(opts.klass)) opts.klass = defaults.classes.sample();
    ...
    if (!defaults.backgrounds.ignoreCaseIncludes(opts.background)) opts.background = defaults.backgrounds.sample();
    ...
    if (!defaults.alignments.ignoreCaseIncludes(opts.alignment)) opts.alignment = defaults.alignments.sample();
    opts.alignment = opts.alignment.capitalizeAll();

    // gender
    if ((opts.gender === undefined) || (opts.gender === '')) opts.gender = defaults.genders.sample();
    if (!defaults.genders.ignoreCaseIncludes(opts.gender)) opts.gender = defaults.genders.sample();
    opts.gender = opts.gender.toLowerCase();

    // theme
    if ((opts.theme === undefined) || (opts.theme === '')) opts.theme = defaults.themes.sample();
    if (!defaults.themes.ignoreCaseIncludes(opts.theme)) opts.theme = defaults.themes.sample();
