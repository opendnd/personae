...
class Renderer {
  static output(person) {
    const { name, gender, age, ageGroup, type, alignment, race, abilities, klass, background, specialty, personalityTraits, ideal, bond, flaw, mannerism, talent, trait, characteristic, DNA } = person;
    ...
    // abilities
    output += 'Abilities: \n\n';
    output += `\tSTR: ${abilities.STR.score} (mod: ${abilities.STR.mod})\n`;
