...
class Renderer {
  static output(person) {
    ...
    if (gender === 'male') {
      ...
      if (renderAppearance('sex').length >= 1) output += `\tAs a male ${race}, they say I am ${renderAppearance('sex')}.\n`;
    } else {
      ...
      if (renderAppearance('sex').length >= 1) output += `\tAs a female ${race}, they say I am ${renderAppearance('sex')}.\n`;
    }
