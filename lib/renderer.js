...
class Renderer {
  static output(person) {
    const { version, name, age, ageGroup, type, alignment, abilities, klass, background, specialty, personalityTraits, ideal, bond, flaw, mannerism, talent, trait, characteristic, DNA } = person;
