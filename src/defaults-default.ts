...
const defaults = {
  ...
  // all previous ageGroup max + current ageGroup dice roll
  // ex: child  - 1d20 => 14 = 14
  // ex: young  - 1d20 => 20 + 16 = 36
  ...
  // TODO: convert more mental/personality traits in genetica also factor in nature vs nurture
  personalityTraits: [],
  ideals: {
    any: [],
    good: [],
